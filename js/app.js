...
//  reload page everytime the browser or  refresh button is clicked
...
const user_avater = document.querySelector(".user_avater");

//fetching api data in this i userd https://randomuser.me/ to get the api  as suggested 
fetch('https://randomuser.me/api/?nat=us&randomapi')
    ...
    .then(function (data) {
        ...
        user_avater.innerHTML = imgSrc;
        title_details_.innerHTML = name_;

        // hover transiction  and change details
